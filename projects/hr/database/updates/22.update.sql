...
ALTER TABLE adjustments ADD tax_reduction_ps		float default 0 not null;

ALTER TABLE employee_adjustments ADD tax_reduction_amount	float default 0 not null;
...
ALTER TABLE tax_types ADD use_key	integer default 1;
ALTER TABLE period_tax_types ADD use_key	integer default 1;
ALTER TABLE period_tax_types ADD org_id			integer references orgs;
ALTER TABLE entity_types ADD 	start_view				varchar(120);
ALTER TABLE employee_advances ADD payment_amount real;
ALTER TABLE employees ADD org_id			integer references orgs;
ALTER TABLE employee_adjustments ADD org_id			integer references orgs;
